...
class CanvasRenderer:
    ...
    def _draw_kpi_panel(self, snap):
        ...
        self._kpi_operator(snap,  x=col1_x + 30,  y=py + 12)
        c.create_line(col2_x, py + 10, col2_x, py + ph - 10, fill=COLOR_PANEL_BORDER, width=1)
        self._kpi_waits(snap,     x=col2_x + 30,  y=py + 12)
